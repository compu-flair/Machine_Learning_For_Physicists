...
class Segment3(Scene):
    def construct(self):
        ...
        # self.wait()
        # self.play(ReplacementTransform(Group(replacement_part5,partition_function),canonical_eq))
        # self.wait()
        ...
        self.play(t_tracker.animate.increment_value(6), run_time=6, rate_func=linear)
        ...
        """,
        color=ORANGE
        ).scale(0.7).next_to(table2, RIGHT*4, aligned_edge=UP)
        self.play(FadeIn(equation6, shift=LEFT*2.1))
        self.wait()
